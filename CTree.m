...
%   Copyright 2010-2018 The MathWorks, Inc.
    ...
    methods(Hidden)
        function this = CTree(X,Y,W,modelParams,...
        ...
        function newobj = update(this,varargin)
            ...
            newobj = update@classreg.learning.classif.CompactClassificationTree(this,varargin{:});
        end        
    end
    ...
    methods(Access=protected)
        function this = fitTree(this)
            if isempty(this.DataSummary.BinnedX)
                Xuse = this.PrivX;                
            else
                Xuse = this.DataSummary.BinnedX;
                this.DataSummary.BinnedX = [];
            end
            N = size(Xuse,1);
            ...
            this.Impl = classreg.learning.impl.TreeImpl.makeFromData(...
                ...
                this.ModelParams.Reproducible,...
                this.DataSummary.BinEdges);
    ...
    methods(Static,Hidden)
        ...
        function [X,Y,W,dataSummary] = removeMissingVals(X,Y,W,dataSummary)
        ...
        function [X,Y,W,dataSummary,classSummary,scoreTransform] = ...
            ...
            [X,Y,W,dataSummary] = ClassificationTree.removeMissingVals(X,Y,W,dataSummary);
